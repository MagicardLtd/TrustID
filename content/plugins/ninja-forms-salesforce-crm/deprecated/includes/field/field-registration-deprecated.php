...
function nfsalesforcecrm_add_field_map_option( $field_id ) {
    ...
    $options = nfsalesforcecrm_build_salesforce_field_list(); // the drop-down list of available fields in Salesforce
...
function nfsalesforcecrm_add_date_interval_option( $field_id ) {
    ...
    $options = nfsalesforcecrm_build_salesforce_field_list();
