...
namespace TrustID_Activation\Inc\Admin;
...
class Admin {
	...
	public function add_plugin_admin_menu() {
		...
		add_menu_page(	__( 'TrustID Software Activation', $this->plugin_text_domain ), //page title
			__( 'TrustID Activation', $this->plugin_text_domain ), //menu title
			'manage_activations', //capability
		...
		// Generate Keys Sub Page
		$generate_keys_page_hook = add_submenu_page(
			$this->plugin_name, //parent slug
			__( 'Generate Keys', $this->plugin_text_domain ), //page title
			__( 'Gernerate Keys', $this->plugin_text_domain ), //menu title
			'manage_options', //capability
			$this->plugin_name, //menu_slug
			array( $this, 'generate_keys_page_content' ) //callback for page content
		);
		...
		add_action( 'load-'.$generate_keys_page_hook, array( $this, 'loaded_generate_keys_submenu_page' ) );
	}
	...
	// show the generate keys form
	public function generate_keys_page_content() {
		include_once( 'views/generate_keys.php' );
	}
	...
	public function loaded_generate_keys_submenu_page() {
		// called when the particular page is loaded.
	}
